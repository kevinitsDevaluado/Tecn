...
company = Company()
company.name = 'Tecnhology SUdo'
company.ruc = '1723598502001'
company.email = 'kevin.alvarado8502@sudodt.com'
company.phone = '23650912'
company.mobile = '0984717773'
company.desc = 'Ventas Al Por Mayor Y Por Menor En Productos para el hogar.'
company.website = 'sudodt.com'
...
u = User()
u.first_name = 'Kevin Paul'
u.last_name = 'Alvarado'
u.username = 'admin'
u.dni = '1723598502'
u.email = 'kevin.alvarado8502@gmail.com'
u.is_active = True
u.is_superuser = True
u.is_staff = True
