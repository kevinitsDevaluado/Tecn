...
class Purchase(models.Model):
    ...
    image = models.ImageField(upload_to='compra/%Y/%m/%d', verbose_name='Imagen', null=True, blank=True)
...
class Sale(models.Model):
    ...
    image = models.ImageField(upload_to='venta/%Y/%m/%d', verbose_name='Imagen', null=True, blank=True)
    date_joined = models.DateField(default=datetime.now)
    end_credit = models.DateField(default=datetime.now)
    subtotal = models.DecimalField(max_digits=9, decimal_places=2, default=0.00)
    dscto = models.DecimalField(max_digits=9, decimal_places=2, default=0.00)
