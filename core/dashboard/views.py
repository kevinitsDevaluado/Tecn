...
from core.pos.models import Product, Sale, Client, Provider, Category, Purchase, Company,Expenses
...
class DashboardView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['inversion'] = gananciatotal
